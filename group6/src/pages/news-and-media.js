        ...
        <div>
            ...
            <main>
                <div className="top-7 flex relative items-center w-full"> {/* Add relative here */}
                    <h1 className='text-3xl pt-7 font-medium w-full text-center absolute'>Media and Articles</h1> {/* Absolute positioning */}
                    <h2 className='absolute pt-7 right-3 font-light text-xl'>Total Articles: {newsMedia.length}</h2> {/* Right aligned */}
                </div>
                <div className='pt-28 pb-8 flex justify-center w-full'>
                    <div className="flex justify-center items-center">
                        <Grid container spacing={3} className='flex justify-center '>
                            {newsMedia.map(newsObject => (
